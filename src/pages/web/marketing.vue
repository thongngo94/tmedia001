      ...
      <section class="section about" id="about" aria-label="about">
        <div class="container">
          ...
          <div class="about-banner img-holder" style="--width: 930; --height: 960;">
            <img src="../../assets/images/website.jpg" width="1000" height="1000" loading="lazy" alt="about banner"
                 class="img-cover">
...
<!--            </p>-->
      ...
      <section class="section service" id="service1" aria-label="service">
        <div class="container">
          ...
          <h2 class="h3 section-title">
            Bảng Báo Giá Dịch Vụ Quản Trị Website</h2>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">3.790.000đ/tháng</a>
                </h3>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">5.790.000đ/tháng</a>
                </h3>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">9.790.000đ/tháng</a>
                </h3>
